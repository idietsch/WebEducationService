...
namespace WebEducationService { // Be detail oriented. Be careful
    public class Startup {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            ...
            using var scope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope();   //Gets migrations to run if not using Visual Studio. Optional, but ADD
