...
namespace WebEducationService.Controllers{
    [Route("api/[controller]")]  //uses controller name - controller
    [ApiController]
    public class MajorsController : ControllerBase{
        ...
        // GET: api/Majors
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Major>>> GetMajor(){ //ActionResult(class): Can return many dif. types:: IEnumerable: getting a collection of majors:: 
            return await _context.Majors.ToListAsync();
        }

        // GET: api/Majors/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Major>> GetMajor(int id){ //async: can do other things while waiting on previous tasks::
